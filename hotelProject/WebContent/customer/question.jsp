...
<form action="customer/questionInsert.jsp">
	<table class="table table-bordered qtable" style="width: 800px;">
		...
		<tr>
			...
			<td>
				<input type="hidden" name="type" id="type">
					<select name="qtype" id="qtpye" class="form-control" style="width: 200px;" required="required">
						<option disabled hidden selected>선택</option>
						<option value="회원가입문의">회원가입문의</option>
						<option value="호텔문의">호텔문의</option>
						<option value="기타문의">기타문의</option>
		...
		<tr>
			<td bgcolor="#fff7e8" style="height: 20px;">성명</td>
			<td>
			<input type="text" name="name" id="name" class="form-control" required="required" style="width: 200px;" value="<%=dto.getName()%>">
			</td>
		</tr>
		<tr>
			<td bgcolor="#fff7e8" style="height: 20px;">비밀번호</td>
			<td>
			<input type="password" name="pass" id="pass" class="form-control" required="required" style="width: 200px; float: left;" value="<%=dto.getPass()%>">*숫자 4자리 입력
			</td>
		</tr>
		<tr>
			<td bgcolor="#fff7e8" style="height: 20px;">이메일</td>
			<td>
			<input type="text" name="email" id="email" class="form-control" required="required" style="width: 500px;" value="<%=dto.getEmail()%>">
			</td>
		</tr>
		<tr>
			<td bgcolor="#fff7e8">휴대전화</td>
			<td>
			<input type="text" name="hp" id="hp" class="form-control" required="required" style="width: 200px;" value="<%=dto.getHp()%>">
			</td>
		</tr>
	</table>
	<br>
